...
import envy.client.mixin.Render3DEvent;
...
import envy.client.utils.render.OLEPOSSUtils;
...
public class OffHandPlus extends Module {
    public OffHandPlus() {
        super(Categories.Combat,Items.TOTEM_OF_UNDYING, "Offhand+", "Better offhand");
    }
