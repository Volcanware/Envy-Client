...
import envy.client.utils.misc.ColorRemover;
...
public class AntiBotPlus extends Module {
	...
	private final SettingGroup sgFilters = settings.createGroup("Trollage");

    public AntiBotPlus() {
        super(Categories.Ghost, Items.PLAYER_HEAD, "Anti-Bot-Plus", "Stops killaura from attacking the anticheat.");
    }
