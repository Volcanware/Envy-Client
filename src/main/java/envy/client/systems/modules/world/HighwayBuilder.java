...
import envy.client.systems.modules.player.AutoEat;
import envy.client.systems.modules.player.AutoGap;
import envy.client.systems.modules.player.AutoTool;
import envy.client.utils.misc.HorizontalDirection;
import envy.client.utils.misc.MBlockPos;
import envy.client.utils.player.CustomPlayerInput;
...
public class HighwayBuilder extends Module {
    ...
    private final Setting<SettingColor> renderMineSideColor = sgRenderMine.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(Envy.INSTANCE.MATHAX_COLOR.r, Envy.INSTANCE.MATHAX_COLOR.g, Envy.INSTANCE.MATHAX_COLOR.b, 150))
        .build()
    );
