...
public class StashFinder extends Module {
    ...
    public StashFinder() {
        super(Categories.World, Items.RED_SHULKER_BOX, "stash-finder", "Searches loaded chunks for storage blocks. Saves to <your minecraft folder>/Envy/Stashes folder.");
    }
    ...
    private File getJsonFile() {
        return new File(new File(new File(Envy.VERSION_FOLDER, "Stashes"), Utils.getWorldName()), "Stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(Envy.VERSION_FOLDER, "Stashes"), Utils.getWorldName()), "Stashes.csv");
    }
