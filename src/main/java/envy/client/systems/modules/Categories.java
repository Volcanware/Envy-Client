...
public class Categories {
    ...
    public static final Category Client = new Category("Client", Items.COMMAND_BLOCK, Color.fromRGBA(Envy.INSTANCE.MATHAX_COLOR.r, Envy.INSTANCE.MATHAX_COLOR.g, Envy.INSTANCE.MATHAX_COLOR.b, 255));
