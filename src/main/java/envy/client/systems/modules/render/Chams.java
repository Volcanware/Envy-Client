...
public class Chams extends Module {
    public static final Identifier BLANK = new Identifier("envy", "textures/blank.png");
    ...
    public final Setting<SettingColor> playersColor = sgPlayers.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(Envy.INSTANCE.MATHAX_COLOR.r, Envy.INSTANCE.MATHAX_COLOR.g, Envy.INSTANCE.MATHAX_COLOR.b, 100))
        .visible(players::get)
        .build()
    );
