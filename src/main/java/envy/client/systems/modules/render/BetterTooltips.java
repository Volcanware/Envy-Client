...
import envy.client.mixin.EntityAccessor;
import envy.client.mixin.EntityBucketItemAccessor;
import envy.client.settings.*;
import envy.client.systems.modules.Categories;
import envy.client.systems.modules.Module;
import envy.client.utils.Utils;
import envy.client.utils.misc.ByteCountDataOutput;
...
import envy.client.utils.tooltip.*;
    ...
    public void applyCompactShulkerTooltip(ItemStack stack, List<Text> tooltip) {
        ...
        if (tag != null) {
            ...
            if (tag.contains("Items", 9)) {
                ...
                if (counts.size() > 5) tooltip.add((Text.translatable("container.shulkerBox.more", counts.size() - 5)).formatted(Formatting.ITALIC));
            }
        }
    }
