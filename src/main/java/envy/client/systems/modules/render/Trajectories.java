...
import envy.client.utils.entity.ProjectileEntitySimulator;
...
public class Trajectories extends Module {
    ...
    private final Setting<SettingColor> sideColor = sgRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(Envy.INSTANCE.MATHAX_COLOR.r, Envy.INSTANCE.MATHAX_COLOR.g, Envy.INSTANCE.MATHAX_COLOR.b, 35))
        .build()
    );
