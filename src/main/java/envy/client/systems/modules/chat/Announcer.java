...
import envy.client.events.entity.player.BreakBlockEvent;
import envy.client.events.entity.player.PickItemsEvent;
import envy.client.events.entity.player.PlaceBlockEvent;
...
public class Announcer extends Module {
    ...
    public boolean onActivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                Envy.EVENT_BUS.subscribe(feature);
                feature.reset();
            }
        }
        return false;
    ...
    public void onDeactivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) Envy.EVENT_BUS.unsubscribe(feature);
        }
    }
