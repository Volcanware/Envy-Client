package envy.client.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<String> font = sgVisual.add(new ProvidedStringSetting.Builder()
        .name("font")
        .description("Custom font to use (picked from .minecraft/Envy/Fonts folder).")
    ...
    public final Setting<Boolean> chatFeedback = sgChat.add(new BoolSetting.Builder()
        .name("chat-feedback")
        .description("Sends chat feedback when Envy performs certain actions.")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<Boolean> toastFeedback = sgToasts.add(new BoolSetting.Builder()
        .name("toast-feedback")
        .description("Sends a toast feedback when Envy performs certain actions.")
        .defaultValue(true)
        .build()
    );
