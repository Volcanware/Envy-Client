...
public class InventoryViewerHud extends HudElement {
    ...
    private static final Identifier TEXTURE = new Identifier("envy", "textures/container/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = new Identifier("envy", "textures/container/container-transparent.png");
