...
import envy.client.systems.hud.modules.*;
...
public class HUD extends System<HUD> {
    ...
    public void onRender2D(Render2DEvent event) {
        if (Envy.mc.options.debugEnabled || Envy.mc.options.hudHidden) return;
    ...
    public static boolean isEditorScreen() {
        return Envy.mc.currentScreen instanceof HudEditorScreen || Envy.mc.currentScreen instanceof HudElementScreen;
    }
