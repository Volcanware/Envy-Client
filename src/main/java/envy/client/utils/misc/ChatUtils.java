...
import envy.client.mixin.ChatHudAccessor;
...
public class ChatUtils {
    ...
    public static void sendMsg(int id, @Nullable String prefixTitle, @Nullable Formatting prefixColor, Text msg) {
        ...
        ((ChatHudAccessor) Envy.mc.inGameHud.getChatHud()).add(message, id);
    }
    ...
    private static MutableText getMatHaxPrefix() {
        ...
        else text.setStyle(text.getStyle().withColor(Envy.INSTANCE.MATHAX_COLOR.getPacked()));
