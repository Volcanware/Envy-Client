...
import envy.client.events.world.BlockActivateEvent;
...
public class EChestMemory {
    ...
    public static void init() {
        Envy.EVENT_BUS.subscribe(EChestMemory.class);
    }
    ...
    private static void onOpenScreenEvent(OpenScreenEvent event) {
        ...
        if (!(Envy.mc.currentScreen instanceof GenericContainerScreen)) return;
        GenericContainerScreenHandler container = ((GenericContainerScreen) Envy.mc.currentScreen).getScreenHandler();
