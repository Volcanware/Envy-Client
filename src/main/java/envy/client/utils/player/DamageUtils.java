...
public class DamageUtils {
    ...
    public static void init() {
        Envy.EVENT_BUS.subscribe(DamageUtils.class);
    }
    ...
    public static double anchorDamage(LivingEntity player, Vec3d anchor) {
        Envy.mc.world.removeBlock(new BlockPos(anchor), false);
        double damage = bedDamage(player, anchor);
        Envy.mc.world.setBlockState(new BlockPos(anchor), Blocks.RESPAWN_ANCHOR.getDefaultState());
        return damage;
    }
