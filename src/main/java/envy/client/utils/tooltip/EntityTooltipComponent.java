...
public class EntityTooltipComponent implements MatHaxTooltipData, TooltipComponent {
    ...
    protected void renderEntity(MatrixStack matrices, int x, int y) {
        ...
        setupAngles();
        EntityRenderDispatcher entityRenderDispatcher = Envy.mc.getEntityRenderDispatcher();
        quaternion2.conjugate();
        entityRenderDispatcher.setRotation(quaternion2);
        entityRenderDispatcher.setRenderShadows(false);
        VertexConsumerProvider.Immediate immediate = Envy.mc.getBufferBuilders().getEntityVertexConsumers();
        entity.age = Envy.mc.player.age;
