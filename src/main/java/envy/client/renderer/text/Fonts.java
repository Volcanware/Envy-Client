package envy.client.renderer.text;
...
public class Fonts {
    ...
    private static final File FONTS_FOLDER = new File(Envy.FOLDER, "Fonts");
    ...
    public static void init() {
        ...
        for (String font : BUILTIN_FONTS) {
            ...
            if (!file.exists()) StreamUtils.copy(Fonts.class.getResourceAsStream("/assets/envy/fonts/" + font), file);
        }
