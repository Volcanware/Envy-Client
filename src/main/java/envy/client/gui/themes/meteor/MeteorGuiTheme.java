...
import envy.client.gui.themes.meteor.widgets.*;
import envy.client.gui.themes.meteor.widgets.input.WMeteorDropdown;
import envy.client.gui.themes.meteor.widgets.input.WMeteorSlider;
import envy.client.gui.themes.meteor.widgets.input.WMeteorTextBox;
import envy.client.gui.themes.meteor.widgets.pressable.*;
...
public class MeteorGuiTheme extends GuiTheme {
    ...
    public final Setting<Double> scale = sgGeneral.add(new DoubleSetting.Builder()
        ...
        .onSliderRelease()
        .onChanged(aDouble -> {
            if (Envy.mc.currentScreen instanceof WidgetScreen) ((WidgetScreen) Envy.mc.currentScreen).invalidate();
        })
        .build()
    );
