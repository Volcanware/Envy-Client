...
import static envy.client.utils.Utils.getWindowHeight;
import static envy.client.utils.Utils.getWindowWidth;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(new Identifier("envy", "textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(new Identifier("envy", "textures/icons/gui/triangle.png"));
        EDIT = addTexture(new Identifier("envy", "textures/icons/gui/edit.png"));
        RESET = addTexture(new Identifier("envy", "textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(new Identifier("envy", "textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(new Identifier("envy", "textures/icons/gui/favorite_yes.png"));
