package envy.client.gui.screens.proxies;
...
import envy.client.systems.proxies.ProxyType;
...
public class ProxiesScreen extends WindowScreen {
    ...
    protected void openEditProxyScreen(Proxy proxy) {
        Envy.mc.setScreen(new EditProxyScreen(theme, proxy));
    }
    ...
    public void initWidgets() {
        ...
        importBtn.action = () -> {
            ...
            if (selectedFile != null) {
                ...
                Envy.mc.setScreen(new ProxiesImportScreen(theme, file));
            }
        };
    }
