...
import envy.client.systems.modules.player.LiquidInteract;
import envy.client.systems.modules.player.NoMiningTrace;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        Envy.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }
