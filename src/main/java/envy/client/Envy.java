...
import envy.client.eventbus.EventBus;
import envy.client.eventbus.EventHandler;
import envy.client.eventbus.IEventBus;
...
import envy.client.renderer.Shaders;
import envy.client.renderer.text.Fonts;
...
import envy.client.systems.modules.client.CapesModule;
import envy.client.systems.modules.client.ClientSpoof;
import envy.client.systems.modules.client.DiscordRPC;
import envy.client.systems.modules.client.MiddleClickFriend;
import envy.client.systems.modules.combat.*;
import envy.client.systems.modules.render.Background;
import envy.client.systems.modules.render.Zoom;
import envy.client.utils.Utils;
import envy.client.utils.Version;
import envy.client.utils.misc.FakeClientPlayer;
import envy.client.utils.misc.KeyBind;
import envy.client.utils.misc.Names;
import envy.client.utils.misc.WindowUtils;
import envy.client.utils.misc.input.KeyAction;
import envy.client.utils.misc.input.KeyBinds;
import envy.client.utils.network.MatHaxExecutor;
import envy.client.utils.player.DamageUtils;
import envy.client.utils.player.EChestMemory;
import envy.client.utils.player.Rotations;
import envy.client.utils.render.EntityShaders;
...
public class Envy implements ClientModInitializer {
    public static Envy INSTANCE;
    ...
    public static List<String> getSplashes() {
        return Arrays.asList(
            ...
            Formatting.YELLOW + "\"is this envy?\"",
    ...
    public void onInitializeClient() {
        ...
        EVENT_BUS.registerLambdaFactory("envy.client", (lookupInMethod, klass) -> (MethodHandles.Lookup) lookupInMethod.invoke(null, klass, MethodHandles.lookup()));
