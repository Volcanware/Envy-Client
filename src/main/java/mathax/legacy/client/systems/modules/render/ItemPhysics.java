...
import mathax.legacy.client.events.render.RenderItemEntityEvent;
import mathax.legacy.client.mixininterface.IItemEntity;
...
public class ItemPhysics extends Module {
    public ItemPhysics() {
        super(Categories.Render, Items.BEEF, "item-physics");
    }
