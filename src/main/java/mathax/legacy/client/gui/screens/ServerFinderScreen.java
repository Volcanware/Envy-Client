...
import mathax.legacy.client.utils.network.ServerPinger;
...
public class ServerFinderScreen extends WindowScreen {
    ...
    private WTextBox ipBox;
    private WIntEdit maxThreadsBox;
    private WButton searchButton;
    private WLabel stateLabel;
    private WLabel checkedLabel;
    private WLabel workingLabel;
