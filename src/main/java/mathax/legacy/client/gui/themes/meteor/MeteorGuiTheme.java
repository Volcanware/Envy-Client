...
import mathax.legacy.client.gui.themes.meteor.widgets.input.*;
...
import mathax.legacy.client.gui.themes.meteor.widgets.*;
import mathax.legacy.client.gui.themes.meteor.widgets.pressable.*;
