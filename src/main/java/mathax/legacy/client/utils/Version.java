    ...
    public static class UpdateChecker {
        ...
        public static void checkForUpdate(boolean cant, boolean found, boolean latest, boolean dev, boolean cantDisable) {
            ...
            switch (checkLatest()) {
                ...
                case Newer_Found -> {
                    MatHaxLegacy.LOG.info(MatHaxLegacy.logPrefix + "There is a new version of MatHax Legacy, v" + getLatest() + "! You are using " + Version.getStylized() + "! You can download the newest version on " + MatHaxLegacy.URL + "Download!");
