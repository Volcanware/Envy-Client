...
public class PacketUtils {
    ...
    static {
        ...
        C2S_PACKETS.put(net.minecraft.network.packet.c2s.common.ClientOptionsC2SPacket.class, "ClientSettingsC2SPacket");
        C2S_PACKETS_R.put("ClientSettingsC2SPacket", net.minecraft.network.packet.c2s.common.ClientOptionsC2SPacket.class);
        ...
        C2S_PACKETS.put(net.minecraft.network.packet.c2s.common.CommonPongC2SPacket.class, "PlayPongC2SPacket");
        C2S_PACKETS_R.put("PlayPongC2SPacket", net.minecraft.network.packet.c2s.common.CommonPongC2SPacket.class);
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.common.CommonPingS2CPacket.class, "PlayPingS2CPacket");
        S2C_PACKETS_R.put("PlayPingS2CPacket", net.minecraft.network.packet.s2c.common.CommonPingS2CPacket.class);
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.query.PingResultS2CPacket.class, "QueryPongS2CPacket");
