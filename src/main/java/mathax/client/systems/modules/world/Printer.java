...
import mathax.client.utils.world.MyUtils;
...
public class Printer extends Module {
    ...
    public Printer() {
        super(Categories.World, Items.BARRIER, "litematica-printer", "Automatically prints open schematics"));
    }
    @EventHandler
    ...
    public enum SortAlgorithm {
        ...
        Nearest(false, Comparator.comparingDouble(value -> MatHax.mc.player != null ? Utils.squaredDistance(MatHax.mc.player.getX(), MatHax.mc.player.getY(), MatHax.mc.player.getZ(), value.getX() + 0.5, value.getY() + 0.5, value.getZ() + 0.5) : 0)),
        Furthest(false, Comparator.comparingDouble(value -> MatHax.mc.player != null ? (Utils.squaredDistance(MatHax.mc.player.getX(), MatHax.mc.player.getY(), MatHax.mc.player.getZ(), value.getX() + 0.5, value.getY() + 0.5, value.getZ() + 0.5)) * -1 : 0));
