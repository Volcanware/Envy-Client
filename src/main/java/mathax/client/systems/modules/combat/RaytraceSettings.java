 ...
 * @author OLEPOSSU
 */
public abstract class RaytraceSettings extends Module {
    public RaytraceSettings() {
        super(Categories.Combat, Items.ACACIA_BOAT, "Raytrace", "Global raytrace settings for every blackout module");
    }
