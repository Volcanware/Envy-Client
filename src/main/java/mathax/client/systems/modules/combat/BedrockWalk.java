...
public class BedrockWalk extends Module {
    ...
    private final Setting<Integer> searchRadius = sgGeneral.add(new IntSetting.Builder()
        .name("search-radius")
        .description("The radius at which envy mode searches for blocks (odd numbers only).")
        .min(3)
        .max(15)
        .sliderMin(3)
        .sliderMax(15)
    ...
    public BedrockWalk() {
        super(Categories.Combat, Items.BEDROCK, "bedrock-walk", "Makes moving on bedrock easier.");
    }
