...
//import mathax.client.utils.chinaman.BO.*;
...
// * @author OLEPOSSU
// */
//public abstract class AutoCrystalRewrite extends Module {
//    public AutoCrystalRewrite() {super(Categories.Combat,Items.ACACIA_BOAT,"Auto Crystal Rewrite", "Breaks and places crystals automatically (but better).");}
...
//                    SettingUtils.attackRangeTo(OLEPOSSUtils.getCrystalBox(Vec3d.ofCenter(new BlockPos(debugRangeX.get(), debugRangeY.get(), debugRangeZ.get()))), new Vec3d(debugRangeX.get() + 0.5, debugRangeY.get(), debugRangeZ.get() + 0.5)));
//            }
//        }
//
