...
public class Bot extends Module {
    ...
    //_____________________________SERVER_______________________________________
    //_____________________________RENDER_______________________________________
    //_____________________________DISCORD______________________________________
    //_____________________________SWARM________________________________________
    //_____________________________FORCE OP_____________________________________
    //_____________________________AUTO LOGIN___________________________________
    //_____________________________FIGHTBOT_____________________________________
    ...
    private final Setting<KillAura.BlockMode> blockMode = sgKillaura.add(new EnumSetting.Builder<KillAura.BlockMode>()
        .name("Rotation mode")
        .description(".")
        .defaultValue(KillAura.BlockMode.Constant)
