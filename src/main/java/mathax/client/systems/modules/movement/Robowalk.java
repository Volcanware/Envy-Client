...
import mathax.client.mixin.PlayerMoveC2SPacketAccessortwo;
...
public class RoboWalk extends Module {
    public RoboWalk() {
        super(Categories.Movement, Items.BEDROCK, "robo-walk", "Bypasses LiveOverflow movement check.");
    }
    ...
    private void onPacketSend(PacketEvent.Send event) {
        if (event.packet instanceof PlayerMoveC2SPacket packet) {
            ...
            ((PlayerMoveC2SPacketAccessortwo) packet).setX(x);
            ((PlayerMoveC2SPacketAccessortwo) packet).setZ(z);
