...
import mathax.client.legacy.systems.modules.player.LiquidInteract;
import mathax.client.legacy.systems.modules.player.NoMiningTrace;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        MatHaxClientLegacy.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }
