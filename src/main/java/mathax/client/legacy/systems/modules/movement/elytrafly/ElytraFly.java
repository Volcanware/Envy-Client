...
import mathax.client.legacy.systems.modules.movement.elytrafly.modes.Packet;
import mathax.client.legacy.systems.modules.movement.elytrafly.modes.Vanilla;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        MatHaxClientLegacy.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        MatHaxClientLegacy.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        MatHaxClientLegacy.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        MatHaxClientLegacy.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
