...
public class Categories {
    ...
    public static final Category Render = new Category("Render", Items.TINTED_GLASS.getDefaultStack());
    public static final Category World = new Category("World", Items.GRASS_BLOCK.getDefaultStack());
    public static final Category Chat = new Category("Chat", Items.BEACON.getDefaultStack());
    public static final Category Fun = new Category("Fun", Items.NOTE_BLOCK.getDefaultStack());
    public static final Category Misc = new Category("Misc", Items.NETHER_STAR.getDefaultStack());
