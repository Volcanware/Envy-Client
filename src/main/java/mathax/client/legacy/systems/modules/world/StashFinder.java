...
public class StashFinder extends Module {
    ...
    private File getJsonFile() {
        return new File(new File(new File(MatHaxClientLegacy.VERSION_FOLDER, "Stashes"), Utils.getWorldName()), "Stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(MatHaxClientLegacy.VERSION_FOLDER, "Stashes"), Utils.getWorldName()), "Stashes.csv");
    }
