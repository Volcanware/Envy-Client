package mathax.client.legacy.utils;
...
import mathax.client.legacy.mixin.ClientPlayNetworkHandlerAccessor;
import mathax.client.legacy.mixin.MinecraftClientAccessor;
import mathax.client.legacy.mixin.MinecraftServerAccessor;
...
import mathax.client.legacy.utils.world.BlockEntityIterator;
import mathax.client.legacy.utils.world.Dimension;
import mathax.client.legacy.utils.world.WorldChunkIterator;
...
public class Utils {
    ...
    public static String getCoper() {
        String apiCoper = Http.get(MatHaxClientLegacy.URL + "Coper/CoperName").sendString();
    ...
    public static String getCoperReplacement() {
        String apiCoperReplacement = Http.get(MatHaxClientLegacy.URL + "Coper/CoperReplacement").sendString();
