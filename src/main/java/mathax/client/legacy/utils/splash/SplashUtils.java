...
public class SplashUtils extends ResourceTexture {
    ...
    protected TextureData loadTextureData(ResourceManager resourceManager) {
        try {
            InputStream input = new FileInputStream(MatHaxClientLegacy.MCCONFIG_FOLDER + location.toString().replace("mathaxlegacy:splash/splash.png","/Splash/Logo/Splash_MatHax.png"));
            TextureData texture;
    ...
    private static final File LOGO_FOLDER = new File(MatHaxClientLegacy.MCCONFIG_FOLDER, "Splash/Logo");
