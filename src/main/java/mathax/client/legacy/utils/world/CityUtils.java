...
import mathax.client.legacy.mixin.AbstractBlockAccessor;
import mathax.client.legacy.systems.friends.Friends;
import mathax.client.legacy.utils.Utils;
import mathax.client.legacy.utils.entity.fakeplayer.FakePlayerEntity;
...
public class CityUtils {
    ...
    private static ArrayList<BlockPos> getTargetSurround(PlayerEntity playerEntity) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            if (!((AbstractBlockAccessor)mc.world.getBlockState(blockPos).getBlock()).isCollidable()) {
                bl = true;
            }
