...
import mathax.client.legacy.gui.screens.AccountsScreen;
import mathax.client.legacy.gui.screens.ModuleScreen;
import mathax.client.legacy.gui.screens.ModulesScreen;
import mathax.client.legacy.gui.screens.ProxiesScreen;
import mathax.client.legacy.gui.tabs.TabScreen;
import mathax.client.legacy.gui.utils.CharFilter;
import mathax.client.legacy.gui.utils.SettingsWidgetFactory;
import mathax.client.legacy.gui.utils.WindowConfig;
import mathax.client.legacy.gui.widgets.*;
import mathax.client.legacy.gui.widgets.containers.*;
import mathax.client.legacy.gui.widgets.input.*;
