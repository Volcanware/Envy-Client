...
import mathax.client.legacy.gui.DefaultSettingsWidgetFactory;
import mathax.client.legacy.gui.GuiTheme;
import mathax.client.legacy.gui.WidgetScreen;
import mathax.client.legacy.gui.renderer.packer.GuiTexture;
import mathax.client.legacy.gui.themes.mathax.widgets.input.WMatHaxDropdown;
import mathax.client.legacy.gui.themes.mathax.widgets.input.WMatHaxSlider;
import mathax.client.legacy.gui.themes.mathax.widgets.input.WMatHaxTextBox;
import mathax.client.legacy.gui.utils.AlignmentX;
...
import mathax.client.legacy.gui.widgets.input.WSlider;
import mathax.client.legacy.gui.widgets.input.WTextBox;
import mathax.client.legacy.gui.themes.mathax.widgets.*;
import mathax.client.legacy.gui.themes.mathax.widgets.pressable.*;
import mathax.client.legacy.gui.widgets.*;
import mathax.client.legacy.gui.widgets.pressable.*;
