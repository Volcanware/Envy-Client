...
import mathax.client.legacy.gui.renderer.operations.TextOperation;
import mathax.client.legacy.gui.renderer.packer.GuiTexture;
import mathax.client.legacy.gui.renderer.packer.TexturePacker;
...
import mathax.client.legacy.utils.render.ByteTexture;
...
import static mathax.client.legacy.utils.Utils.getWindowHeight;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(new Identifier("mathaxlegacy", "textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(new Identifier("mathaxlegacy", "textures/icons/gui/triangle.png"));
        EDIT = addTexture(new Identifier("mathaxlegacy", "textures/icons/gui/edit.png"));
        RESET = addTexture(new Identifier("mathaxlegacy", "textures/icons/gui/reset.png"));
