package mathax.client.legacy.bus;

import mathax.client.legacy.bus.listeners.IListener;
import mathax.client.legacy.bus.listeners.LambdaListener;
...
public interface IEventBus {
     ...
     * @param packagePrefix Package prefix that this factory will be used for, eg "mathax.client.legacy.bus"
